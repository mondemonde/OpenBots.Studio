...
namespace DevNoteHub.API.Service
{
    public class SynchManager : ISynchManager
    {
        ...
        //IMacManager _mngr;
        IMachineManager _mngr;


        public SynchManager(IMachineManager mngr)
        {
            _mngr = mngr;
        }
        ...
        void CreatePublisher(IMachineManager mngr)
        {
        ...
        public string DecryptSvcBusConnString(IMachineManager mngr)
        {
        ...
        public string DecryptSvcBusEntityPathTopic(IMachineManager mngr)
        {
            string result = string.Empty;
            var mac = mngr.GetMachineRecord();
