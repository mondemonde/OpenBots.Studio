...
namespace Steeroid.Business.Areas.Communication.WebApi
{
    /// <summary>
    /// 
    /// </summary>
    public static class BotHttpClient
    {
        ...
        public static async Task<HttpResponseMessage> TaskHttpGetToDesigner(string action,
            string controller = "devnote", int? devPort = 9000)
        {
            HttpResponseMessage respond = new HttpResponseMessage
            {
                StatusCode = System.Net.HttpStatusCode.NotFound
        ...
        public static async Task<HttpResponseMessage> PostToAzure(DevNoteCmdEvent devEvent, string controller = "Event")
        {
        ...
        //    ////("http://localhost:9000/bot/devnote/GetParameters?eventTag=test");
        ...
        public static void Log(string msg, bool isErrorMessage = false)
        {
            if (isErrorMessage)
