...
namespace Steeroid.Infra2._0.Areas.Bot
{
    public class ProcessLauncher
    {
        ...
        private static uint GetActiveUserSessionId(string domainUsername)
        {
            ...
            if (WTSEnumerateSessions(WTS_CURRENT_SERVER_HANDLE, 0, 1, ref pSessionInfo, ref sessionCount) != 0)
            {
                ...
                for (var i = 0; i < sessionCount; i++)
                {
                    ...
                    if (si.State == WTS_CONNECTSTATE_CLASS.WTSActive && sessionUsername.ToLower() 
        ...
        public static bool LaunchProcess(String commandLine, 
            ...
            out PROCESS_INFORMATION processInfo)
        {
            ...
            IntPtr hUserTokenDup = IntPtr.Zero, 
                hPToken = IntPtr.Zero, 
                hProcess = IntPtr.Zero, envBlock = IntPtr.Zero;
